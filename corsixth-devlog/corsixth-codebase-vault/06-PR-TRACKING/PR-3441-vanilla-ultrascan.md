...
## Status
Sprint 10 proof done. 5000 ticks gate on (preserve) 0 crashes, gate off (blocked) 0 crashes via Lua loop; vault research updated. Timebox 30m.
...
## Next
Sprint 11: fix empty branch do end maintainer pref.
